$(document).ready(function () {
    ...
    $('body').on('click', '[id="btnThanhToan"]', function () {
        ...
        $.ajax({
            url: $('#requestPath').val() + "admin/dondatbantiec/thanhtoan",
            data: formData,
            dataType: 'html',
            type: 'POST',
            processData: false,
    ...
    $('body').on('click', '[id="btnCapNhatThongTinDonHang"]', function () {
        ...
        $.ajax({
            url: $('#requestPath').val() + "admin/dondatbantiec/capnhatthongtindonhang",
            data: formData,
            dataType: 'html',
            type: 'POST',
            processData: false,
    ...
    $('body').find('[id="btnLuuCapNhatDonHang"]').on('click', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: $('#requestPath').val() + "admin/dondatbantiec/submitcapnhatdonhang",
                    data: formData,
                    dataType: 'html',
                    type: 'POST',
                    processData: false,
