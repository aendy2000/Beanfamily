$(document).ready(function () {
    ...
    //Giỏ hàng thực đơn hằng ngày
    $('body').on('click', '[id^="tangsoluonggiohangthucdonhangngay-"]', function () {
        var id = $(this).attr('name');
        ...
        if ($('[id="giasanphamthucdonhangngay-' + id + '"]').attr('dongia') != "CHONPHANLOAI") {
            ...
            if (inpSL < 100) {
                ...
                if (dongia != "CHONPHANLOAI") {
                    ...
                    $('body').find('[id="soluonggiohangthucdonhangngay-' + id + '"]').val(inpSL + 1);
    ...
    $('body').on('click', '[id^="giamsoluonggiohangthucdonhangngay-"]', function () {
        var id = $(this).attr('name');
        if ($('[id="giasanphamthucdonhangngay-' + id + '"]').attr('dongia') != "CHONPHANLOAI") {
        ...
        if ($('[id="giasanphamthucdonhangngay-' + id + '"]').attr('dongia') != "CHONPHANLOAI") {
            ...
            if (inpSL.length < 1) {
                ...
                if (Number(inpSL) < 1) {
                    ...
                    $('body').find('[id="soluonggiohangthucdonhangngay-' + id + '"]').val(inpSL);
